    ...
    <div>
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="relative z-10 flex items-baseline justify-between pt-24 pb-6 border-b border-gray-200">
                <h1 class="text-4xl font-extrabold tracking-tight text-gray-900">Welcome From August Shop :)</h1>
                ...
                <div class="relative inline-block text-left">
                    ...
                    <div class="origin-top-right absolute right-0 mt-2 w-40 rounded-md shadow-2xl bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1" style="display: none;">
            ...
            <section aria-labelledby="products-heading" class="pt-6 pb-24">
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
                    ...
                    <form class="hidden lg:block">
                        <div x-data="{showCategory: true}" class="border-b border-gray-200 py-6">
                            <div class="flex justify-between align-middle">
                                    ...
                                    <span class="ml-6 flex items-center text-white bg-indigo-600">
                                        <!--
                                        Expand icon, show/hide based on section open state.
        
                                        Heroicon name: solid/plus-sm
                                        -->
                                        <svg x-show="!showCategory" x-on:click="showCategory = true" class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path fill-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clip-rule="evenodd" />
                                        ...
                                        Heroicon name: solid/minus-sm
                                        -->
                                        <svg x-show="showCategory" x-on:click="showCategory = false" class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path fill-rule="evenodd" d="M5 10a1 1 0 011-1h8a1 1 0 110 2H6a1 1 0 01-1-1z" clip-rule="evenodd" />
                                        </svg>
                                    </span>
                            </div>
                            <!-- Filter section, show/hide based on section state. -->
                            <div x-show="showCategory" class="pt-6" id="filter-section-1">
                                <div class="space-y-4">
                                    <div class="flex items-center">
